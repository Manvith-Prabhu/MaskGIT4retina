...
class Trainer(object):
    ...
    def get_data(self):
        ...
        if self.args.data == "mnist":
            ...
            data_train = CIFAR10('~/data/cifar', train=True, download=True,
            ...
            data_test = CIFAR10('~/data/cifar', train=False, download=False,
                                transform=transforms.Compose([
                                    transforms.Resize(self.args.img_size),
                                    transforms.ToTensor(),
                                    transforms.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5))
            ...
            data_train = ImageFolder(root="/home/kwang/mprabhu/Dataset/Preprocessed_ODIR5k/Training", transform=transform)
